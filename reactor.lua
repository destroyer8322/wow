...
function reactorInfoScreen()
	...
	f.draw_text_lr(mon, 4, 9, 3, "Output Gate:", f.format_int(flowgate.getSignalLowFlow()).." rf/t", colors.white, colors.lightBlue, colors.black)
	f.draw_text_lr(mon, 4, 10, 3, "Input Gate:", f.format_int(inputFlowgate.getSignalLowFlow()).." rf/t", colors.white, colors.lightBlue, colors.black)
